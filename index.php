		...
		<div class="card-body" style="width:100%;">
			...
			<form action="car-list.php" method="GET">
				<div class="form-group">
					...
					<input type="date" id="pickup" name="pickup" class="form-control" min=<?php echo date("Y-m-d"); ?>>
				</div>
				...
				<div class="form-group">
					...
					<input type="date" id="return" name="return" class="form-control" min=<?php echo date("Y-m-d"); ?>>
				</div>
				<input type="submit" class="btn btn-primary" name="confirm_date" value="Search"/>
			</form>
			<br>
